...
},
{
    ...
    image: "images/arsenalvillareport.jpg",
...
},
{
    ...
    content: [
      ...
      ">> \"He's not that guy who needs that many ball touches to create the danger in an opponent's box... he's very intense against the ball, he made another step during pre-season, therefore I'm quite happy with him.\"",
...
},
{
    ...
    content: [
      ...
      ">> \"If you're told you're essentially not good enough, then you're going to want to prove people wrong.\"",
...
},
{
    ...
    content: [
      ...
      ">> The situation is far from ideal. It is quite complex.",
...
},
{
    ...
    content: [
      ...
      ">> We suffered physically but we knew that before the game. We were not ready to fight the duels... we didn't fight in the right way.",
...
},
{
    ...
    content: [
      ...
      ">> Fabrizio Romano gave his trademark \"here we go\" on Friday, with an improved package of £65m plus £5m in add-ons agreed after United's original £65m bid was rejected.",
...
},
{
    ...
    content: [
      ...
      ">> We were really dominant and we flowed with the ball. Overall the performance was positive, with some big individual performances.",
...
},
{
    ...
    content: [
      ...
      ">> Three promoted clubs finding their feet, brand-new head coaches making their away-day bows at Newcastle and Everton, and Manchester City looking to shake off their Community Shield hangover.",
    ],
    sources: [
...
},
{
    ...
    content: [
      ...
      ">> I just think we're looking to strengthen the squad. We're certainly working towards that, making the most of the situation that we have and trying to improve things and trying to move forward... And I think we're a good way to doing that, so far.",
...
},
{
    ...
    content: [
      ...
      ">> It happened with Rodri and the same thing is happening with Savinho. Since day one, he has asked me that he wants to leave.",
...
},
{
    ...
    content: [
      ...
      ">> It's certainly the ambition of the club and the owners to be the best club in the world.",
...
},
{
    ...
    content: [
      ...
      ">> For Tottenham, letting Vicario leave on loan -- rather than trying to keep two senior goalkeepers competing for one shirt -- is as much a statement about Kinsky's ceiling as it is about Vicario's misfortune.",
    ],
    sources: [
...
},
{
    ...
    content: [
      ...
      ">> Unfortunately after 30 seconds we conceded the first one... the reaction was good, before they scored the second goal we had three or four chances.",
...
},
{
    ...
    content: [
      ...
      ">> Max Dowman has already spent the last twelve months rewriting the Premier League's record books before he was legally allowed to change in Arsenal's first-team dressing room.",
...
},
{
    ...
    content: [
      ...
      ">> Mikel Arteta offered a striking compliment to his opposite number ahead of the match, rating Maresca as good as Pep Guardiola.",
  ...
  },
{
    ...
    content: [
      ...
      ">> Gakpo would become the latest name in what is shaping up to be one of the most aggressive rebuilds in the Premier League this summer.",
    ],
    sources: [
  ...
  },
{
    ...
    content: [
      ...
      ">> It is not the profile of a squad that merely needs fine-tuning -- it is the profile of one being rebuilt close to the foundations.",
    ],
    sources: [
  ...
  },
{
    ...
    content: [
      ...
      ">> The improvement Arsenal are banking on this season has to come from within the existing squad rather than from a marquee wide addition.",
    ],
    sources: [
  ...
  },
{
    ...
    content: [
      ...
      ">> It is a squad now being shaped in his own image for the first time, rather than one he took over midway through a crisis.",
    ],
    sources: [
  ...
  },
{
    ...
    content: [
      ...
      ">> Romero's future was never really about staying at Tottenham long-term, only about which suitor Spurs were prepared to deal with.",
  ...
  },
{
    ...
    content: [
      ...
      ">> That bet paid off within a half.",
  ...
  },
{
    ...
    content: [
      ...
      ">> It's a special moment to sign a new deal and a proud moment for me and my family.",
  ...
  },
{
    ...
    content: [
      ...
      ">> Omar Marmoush and Savinho have both been told their futures are, in Maresca's words, essentially their own decision.",
  ...
  },
{
    ...
    content: [
      ...
      ">> Antonio Conte publicly distanced himself from the move within days, calling Spence \"an investment by the club\" rather than his own signing.",
...
},
{
    ...
    content: [
      ...
      ">> A League Two side dumping out a Championship promotion fancy, a string of shootouts, and a second round draw that has left several unfashionable names with a genuine route to Wembley.",
...
},
{
    ...
    content: [
      ...
      ">> The Southern section draw sent Xabi Alonso's Chelsea to a home tie against Jack Wilshere's Luton Town -- the fifth time the two clubs have met in five years.",
...
},
{
    ...
    content: [
      ...
      ">> Beating PSG would be a statement in its own right, not just for Villa's season but for English football's credibility against the current dominant force in Europe.",
    ],
    sources: [
  ...
  },
{
    ...
    content: [
      ...
      ">> Anderson and Rogers show what the buying end of that equation looks like when two clubs both refuse to blink.",
  ...
  },
{
    ...
    content: [
      ...
      ">> That uncertainty is, in a sense, the point of a loan with a buy option rather than an outright transfer.",
  ...
  },
{
  ...
  },
  {
    ...
    content: [
      ...
      ">> While Spurs deserve credit for an ambitious transfer window, expectations will inevitably rise alongside investment.",
    ],
    sources: [
  ...
  },
  {
    ...
    content: [
      ...
      ">> Tottenham's rebuild is not only about signing better players, but about creating a team with a shared mentality and a clear purpose.",
    ],
    sources: [
